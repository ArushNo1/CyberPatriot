...
#		echo "t1 is: $t1" | tee -a "$LOG" 2>> "$ELOG"
	...
	# Check net.ipv4.conf.all.log_martians in the running config
	syspar="net.ipv4.conf.all.log_martians"
	regpar="net\.ipv4\.conf\.all\.log_martians"
	spv="1"
	src4_chk_fix
	test1=$t1
...
#	echo "Test2 is $test2" | tee -a "$LOG" 2>> "$ELOG"
	...
	# Check net.ipv4.conf.default.log_martians in the running config
	syspar="net.ipv4.conf.default.log_martians"
	regpar="net\.ipv4\.conf\.default\.log_martians"
	spv="1"
	src4_chk_fix
	test3=$t1
