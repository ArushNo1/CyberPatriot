...
map_to_benchmark()
{
        ...
        case $_DISTRO in
                OSX)
                        ...
                        then
                                BENCHMARK="CIS_Apple_macOS_11.0_Big_Sur_Benchmark_v4.0.0-xccdf.xml"
                                PROFILE1="Level 1"
                                PROFILE2="Level 2"
                                ARFORXML="-x"
                        fi
                        ...
                        then
                                BENCHMARK="CIS_Apple_macOS_12.0_Monterey_Benchmark_v3.1.0-xccdf.xml"
                                PROFILE1="Level 1"
                                PROFILE2="Level 2"
                                ARFORXML="-x"
                        fi
                        ...
                        # OSX 13.0
                        if [ `expr $_VER \>= 22 \& $_VER \< 23` -eq 1 ]
                        then
                                BENCHMARK="CIS_Apple_macOS_13.0_Ventura_Benchmark_v2.1.0-xccdf.xml"
                                PROFILE1="Level 1"
                                PROFILE2="Level 2"
                                ARFORXML="-x"
                        fi
                        ...
                        # OSX 14.0
                        if [ `expr $_VER \>= 23` -eq 1 ]
                        then
                                BENCHMARK="CIS_Apple_macOS_14.0_Sonoma_Benchmark_v1.1.0-xccdf.xml"
                                PROFILE1="Level 1"
                                PROFILE2="Level 2"
                                ARFORXML="-x"
                        fi
                ...
                Debian)
                        ...
                        then
                                BENCHMARK="CIS_Debian_Linux_11_Benchmark_v2.0.0-xccdf.xml"
                                PROFILE1="Level 1 - Server"
                                PROFILE2="Level 2 - Server"
                        elif [  `expr $_VER \>= 12 \& $_VER \< 13` -eq 1  ];
                        then
                ...
                Ubuntu)
                	# Ubuntu 14.04
                        ...
                        then
                                BENCHMARK="CIS_Ubuntu_Linux_18.04_LTS_Benchmark_v2.2.0-xccdf.xml"
                                PROFILE1="Level 1 - Server"
                                PROFILE2="Level 2 - Server"
                        fi
                        ...
                        then
                                BENCHMARK="CIS_Ubuntu_Linux_22.04_LTS_Benchmark_v2.0.0-xccdf.xml"
                                PROFILE1="Level 1 - Server"
                                PROFILE2="Level 2 - Server"
                        fi

                        # Ubuntu 24.04
                        if [ `expr $_VER == 24.04` -eq 1 ]
                        then
                                BENCHMARK="CIS_Ubuntu_Linux_24.04_LTS_Benchmark_v1.0.0-xccdf.xml"
                                PROFILE1="Level 1 - Server"
                                PROFILE2="Level 2 - Server"
                        fi
			...
			;;
                RedHat)
                        ...
                        if [ `expr $_VER \>= 9 \& $_VER \< 10` -eq 1 ]
                        then
                                BENCHMARK="CIS_Red_Hat_Enterprise_Linux_9_Benchmark_v2.0.0-xccdf.xml"
                                PROFILE1="Level 1 - ${ROLE}"
                                PROFILE2="Level 2 - ${ROLE}"
                        fi
                ...
                Oracle)
                        ...
                        if [ `expr $_VER \>= 7 \& $_VER \< 8` -eq 1 ]
                        then
                                BENCHMARK="CIS_Oracle_Linux_7_Benchmark_v4.0.0-xccdf.xml"
                                PROFILE1="Level 1 - ${ROLE}"
                                PROFILE2="Level 2 - ${ROLE}"
                        fi
                        ...
                        if [ `expr $_VER \>= 8 \& $_VER \< 9` -eq 1 ]
                        then
                                BENCHMARK="CIS_Oracle_Linux_8_Benchmark_v3.0.0-xccdf.xml"
                                PROFILE1="Level 1 - ${ROLE}"
                                PROFILE2="Level 2 - ${ROLE}"
                        fi
                        ...
                        if [ `expr $_VER \>= 9 \& $_VER \< 10` -eq 1 ]
                        then
                                BENCHMARK="CIS_Oracle_Linux_9_Benchmark_v2.0.0-xccdf.xml"
                                PROFILE1="Level 1 - ${ROLE}"
                                PROFILE2="Level 2 - ${ROLE}"
                        fi
                ...
                CentOS)
                  ...
                  if [ `expr $_VER \>= 7 \& $_VER \< 8` -eq 1 ]
                  then
                    BENCHMARK="CIS_CentOS_Linux_7_Benchmark_v4.0.0-xccdf.xml"
                    PROFILE1="Level 1 - ${ROLE}"
                    PROFILE2="Level 2 - ${ROLE}"
                  fi
